...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Show at bottom on mobile to avoid coloring the iOS status bar red on errors
      // Safe area padding ensures toasts don't overlap the home indicator
      "fixed bottom-0 z-[100] flex max-h-screen w-full flex-col p-4 pb-safe sm:right-0 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
